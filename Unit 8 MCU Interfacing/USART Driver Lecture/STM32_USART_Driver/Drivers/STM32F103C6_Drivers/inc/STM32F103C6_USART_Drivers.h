...
#define UART_Parity__EVEN						((uint32_t)(1<<10))			//Bit 10 PCE: Parity Control enable
#define UART_Parity__ODD						((uint32_t)(1<<10 | 1<<9))  //bit 9 PS: Parity selection
...
//todo MCAL_USART_Init();	  Synchronouss
